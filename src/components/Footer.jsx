    ...
    return (
        <footer className="relative text-white">
            <div className="absolute top-0 left-0  bg-gradient-to-b from-gray-900 via-gray-950 to-black w-[100%] overflow-hidden">
                ...
                <div className="grid lg:grid-cols-4 gap-20 sm:grid-cols-1 px-20 py-12s">
                    ...
                    <div>
                        ...
                        <li className="my-4 list-none">
                            <Link href="/services/obtaining-an-emirates-id">Obtain Emirates ID</Link>
                        </li>
                        <li className="my-4 list-none">
                            <Link href="/services/enewing-an-emirates-id">Renew Emirates ID</Link>
                        </li>
                        <li className="my-4 list-none">
                            <Link href="/services/opening-companies-in-oman">Setup Omani Company</Link>
                        </li>
                        <li className="my-4 list-none">
