...
export function Hero() {
  ...
  return (
    ...
    >
      <div className="animation-delay-8 animate-fadeIn pt-1 flex flex-col items-center justify-center px-4 text-center md:pt-20">
        <div className="z-10 mb-6 mt-5 sm:justify-center md:mb-4 md:mt-2">
          {/*
        ...
        <div className="mb-10 mt-4 md:mt-6">
          <div className="px-2">
            <div className="border-white relative mx-auto h-full max-w-7xl border p-6 [mask-image:radial-gradient(800rem_96rem_at_center,white,transparent)] md:px-12 md:py-20">
              <h1 className="flex font-serif select-none flex-col px-3 py-2 text-center text-5xl font-semibold leading-none tracking-tight md:flex-col md:text-8xl lg:flex-row lg:text-8xl text-white">
                <DIcons.Plus
                  strokeWidth={4}
                ...
                />
                Empowering Your Business with Expert Setup and Investments!
              </h1>
          ...
          <h2 className="mt-8 text-2xl md:text-2xl text-gray-50">
