...
const InfiniteScrollImages = () => {
    const settings = {
        ...
        slidesToScroll: 1,
        autoplay: true,
        autoplaySpeed: 2000, // Slower speed for autoplay
        cssEase: "linear",
        focusOnSelect: true
    };

    return (
        <div className="relative overflow-hidden pb-20 pt-10 isolate bg-gradient-to-t from-gray-900 via-gray-950 to-black">
            <svg viewBox="0 0 1024 1024" className="absolute left-1/2 top-1/2 -z-10 h-[64rem] w-[64rem] -translate-x-1/2 translate-y-0 [mask-image:radial-gradient(closest-side,white,transparent)] sm:left-full sm:-ml-80 lg:left-1/2 lg:ml-0 lg:-translate-x-1/2 lg:translate-y-0" aria-hidden="true"><circle cx="512" cy="512" r="512" fill="url(#759c1415-0410-454c-8f7c-9a820de03641)" fillOpacity="0.7"></circle><defs><radialGradient id="759c1415-0410-454c-8f7c-9a820de03641"><stop stopColor="#14b8a6"></stop><stop offset="1" stopColor="#0e7490"></stop></radialGradient></defs>
            </svg>

            <h2 className="text-center text-2xl md:text-4xl font-bold mb-4 py-10 text-white">Our Partners</h2>
