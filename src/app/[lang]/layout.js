...
export async function generateMetadata({ params }) {
  ...
  return {
    title: dictionary.home_title || "Tas Heel",
    description: dictionary.home_description || "Tas Heel Company with best services in visa, transport, investment and technology.",
    openGraph: {
